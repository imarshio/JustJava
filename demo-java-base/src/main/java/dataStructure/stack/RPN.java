...
/**
 * @author masuo
 * @data 24/4/2022 上午9:21
 * @Description 逆波兰表达式 Reverse Polish Notation
 */

public class RPN {
    // 将一个表达式转化成逆波兰式
    public void turnToRPN() {
    ...
    private int evalRPN(Stack<String> stack) {
        int sum = 0;
        while (!stack.isEmpty()) {
